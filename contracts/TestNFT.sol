...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
    function _initialize(string memory name_, string memory symbol_, uint256 maxSupply_) public {
        _name = name_;
        _symbol = symbol_;
    ...
    function _baseURI() internal view virtual returns (string memory) {
        return "https://ipfs.io/ipfs/QmNYHmRZ1VS66jT2oyHEv484krXN7XCvVtMXmTTwXdNzsG/";
    }
